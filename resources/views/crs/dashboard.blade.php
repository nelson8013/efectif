            ...
            <div class="container px-6 mx-auto grid">
              ...
              <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                ...
                >
                  ...
                  <div>
                    <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total Farmers</p>
                ...
                >
                  ...
                  <div>
                    <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total Loan Amount</p>
